...
export const elevenTools = [
    {
        name: "eleven_outbound_call",
        description: "Trigger an outbound AI voice call to a lead using ElevenLabs Conversational AI",
        input_schema: {
            type: "object",
            properties: {
                agentId: { type: "string" },
...
export async function handleElevenTool(name, input) {
    switch (name) {
